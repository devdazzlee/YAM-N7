    ...
    <>
      ...
      <motion.div
        style={{
          ...
          height: '500px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(200,164,107,0.05) 0%, rgba(200,164,107,0.01) 45%, rgba(0,0,0,0) 70%)',
          pointerEvents: 'none',
      ...
      <motion.div
        style={{
          ...
          translateX: '-50%',
          translateY: '-50%',
          background: hoverType === 'image' ? 'rgba(200, 164, 107, 0.08)' : 'transparent',
          borderColor: hoverType === 'link' ? '#FFFFFF' : '#C8A46B',
          opacity: isVisible ? 1 : 0,
