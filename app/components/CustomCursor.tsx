    ...
    <>
      ...
      <motion.div
        style={{
          ...
          height: '500px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(232,180,160,0.05) 0%, rgba(232,180,160,0.01) 45%, rgba(0,0,0,0) 70%)',
          pointerEvents: 'none',
      ...
      <motion.div
        style={{
          ...
          translateX: '-50%',
          translateY: '-50%',
          background: hoverType === 'image' ? 'rgba(232,180,160, 0.08)' : 'transparent',
          borderColor: hoverType === 'link' ? '#FFFFFF' : '#E8B4A0',
          opacity: isVisible ? 1 : 0,
