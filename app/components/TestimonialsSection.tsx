      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-1.5 sm:py-2 shadow-sm">
            ...
            <span className="text-sm sm:text-base font-bold text-[#1A1A1A]">{overallRating.toFixed(1)}</span>
              ...
              >
                {currentReviews.map((review, index) => (
                  <div
                    ...
                    className="bg-gradient-to-br from-[#FBF6EC]/50 to-white rounded-xl p-4 sm:p-5 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col h-full border border-gray-100"
                  >
                    {/* Stars */}
                    <div className="mb-3">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200/80 mt-auto">
                      <div className="flex items-center gap-2.5">
                        {review.profile_photo_url ? (
                          ...
                          <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-[#C5A059] to-[#1A1A1A] flex items-center justify-center text-white font-bold text-sm ring-2 ring-white shadow-sm">
                            {review.author_name.charAt(0)}
                          </div>
                        )}
                        <div>
                          <p className="font-semibold text-[#1A1A1A] text-sm sm:text-[15px] leading-tight">
                            {review.author_name}
                          </p>
                          {review.store_name && (
                            <p className="text-[11px] sm:text-xs text-[#C5A059] mt-0.5">
                              {review.store_name}
                            </p>
                          )}
                        </div>
