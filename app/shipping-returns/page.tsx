...
export default function ShippingReturnsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-card text-foreground py-16 sm:py-20 md:py-24 border-b border-border/40 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground/90 leading-relaxed px-2 sm:px-0">
      ...
      <section className="py-10 sm:py-14 md:py-16 bg-surface-muted/50">
          ...
          >
            <div className="text-center mb-8 sm:mb-10">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <div className="w-14 h-1 bg-primary-dark rounded-full"></div>
              </div>
            </div>
            ...
            <div className="bg-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 border border-border/40 space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-muted leading-relaxed">
                    Enjoy free nationwide delivery on all orders over <span className="font-semibold text-foreground">Rs. 5,000</span>.
                  </p>
                </div>
              </div>
              ...
              {/* Standard Charges */}
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-surface rounded-xl flex items-center justify-center mt-0.5">
                  <CreditCard className="w-5 h-5 text-primary-dark" />
                </div>
                <div>
                  <h3 className="font-bold text-foreground text-base sm:text-lg mb-1">Standard Delivery Charges</h3>
                  <p className="text-sm sm:text-base text-muted leading-relaxed">
                ...
                <div className="w-full">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {deliveryTimelines.map((item) => (
                      <div
                        key={item.area}
                        className="bg-surface-muted/60 rounded-xl p-4 text-center border border-border"
                      >
                        <span className="text-2xl mb-2 block">{item.icon}</span>
                        <p className="font-semibold text-foreground text-sm mb-0.5">{item.area}</p>
                        <p className="text-xs text-primary-dark font-medium">{item.time}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-foreground text-base sm:text-lg mb-1">Handling</h3>
                  <p className="text-sm sm:text-base text-muted leading-relaxed">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-border/40">
                ...
                <p className="text-sm sm:text-base text-muted leading-relaxed">
                  If you would prefer a different fragrance, concentration, or size from our <span className="font-semibold text-foreground">1400+ fragrance collection</span>, we can process an exchange. Any price difference will be settled before the new item is dispatched.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-foreground/10 text-foreground border border-foreground/20 px-6 py-3 rounded-full font-semibold text-sm sm:text-base hover:bg-surface-muted/20 transition-colors"
                >
