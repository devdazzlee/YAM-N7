      ...
      <section className="bg-gradient-to-r from-[#1A1A1A] to-[#C5A059] text-white py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90">YAM-N7 | Terms & Conditions</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            <div className="space-y-8 text-[#6B7280] leading-relaxed">
              ...
              <div>
                <h2 className="text-2xl font-bold text-[#1A1A1A] mb-4">3. Product Information & Accuracy</h2>
                <p>
              ...
              <div>
                <h2 className="text-2xl font-bold text-[#1A1A1A] mb-4">4. Pricing & Currency</h2>
