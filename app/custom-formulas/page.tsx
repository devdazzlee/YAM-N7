      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#FBF6EC] rounded-2xl p-8 md:p-12 space-y-8"
          >
            ...
            <div className="space-y-6 text-[#6B7280]">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-[#C5A059] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">
                    1
                  </div>
                  <div>
                    <h3 className="font-semibold text-[#1A1A1A] mb-2">Consultation</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1A1A1A] mb-2">Custom Formula</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1A1A1A] mb-2">Preparation</h3>
